...
namespace vXboxNS {
	...
	// Interface Functions
		...
		VXBOX_API BOOL	__cdecl SetDpadOff2(UINT UserIndex, UINT Value)
		{
			//g_Gamepad[UserIndex - 1].wButtons &= 0xFFF0;
			g_Gamepad[UserIndex - 1].wButtons &= ~Value;
			return XOutputSetState(UserIndex, &g_Gamepad[UserIndex - 1]);
		...
		VXBOX_API BOOL	__cdecl	 SetDpadOffUp(UINT UserIndex)
		{
			return SetDpadOff2(UserIndex, DPAD_UP);
		}
		...
		VXBOX_API BOOL	__cdecl	 SetDpadOffRight(UINT UserIndex)
		{
			return SetDpadOff2(UserIndex, DPAD_RIGHT);
		}
		...
		VXBOX_API BOOL	__cdecl	 SetDpadOffDown(UINT UserIndex)
		{
			return SetDpadOff2(UserIndex, DPAD_DOWN);
		}
		...
		VXBOX_API BOOL	__cdecl	 SetDpadOffLeft(UINT UserIndex)
		{
			return SetDpadOff2(UserIndex, DPAD_LEFT);
		}
